...
class Healt extends StatefulWidget {
  const Healt({Key? key}) : super(key: key);

  @override
  _HealtState createState() => _HealtState();
}
...
class _HealtState extends State<Healt> {
  ...
  Widget build(BuildContext context) {
    ...
    var future = NewsApi().fetchArticalByCategory('health');
    Future<void> now()async {
      return NewsApi().fetchArticalByCategory('health').then((user){
        setState(() {
          future=user;
        });
      });
